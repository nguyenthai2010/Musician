<?php
	...
	$thumbnail = rwmb_meta( "{$ss_prefix}portfolio_thumbnail",  "type=image&size=spnoy-mosaic-gallery-layout-4" );
	$thumbnail = array_shift($thumbnail);

?>
<div class="ss-tile has-layout-4 <?php echo $html_class; ?>" >
